...
class unrolled_list<T, NodeMaxSize, Allocator>::const_reverse_iterator {
    public:
        ...
        constexpr explicit const_reverse_iterator(NodePointer node, pointer index) : node_(node) {
            ptr_ = index;
        }
        constexpr const_reverse_iterator(const const_reverse_iterator& other) : node_(other.node_), ptr_(other.ptr_) {
        }
